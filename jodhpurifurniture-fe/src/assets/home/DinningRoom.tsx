...
import { useGetDiningSet } from "@/service/home";
...
function DinningRoom() {
  ...
  const { data: diningSEt, isLoading } = useGetDiningSet("50", {
    enabled: inView,
  });
  const diningSetData = diningSEt?.data ?? [];
...
{/* Burhan code Here */}
      ...
      <section className="container-fluid section-7 " ref={ref}>
        <div className="container">
          <div className="d-flex center-section">
            <div>
              <Typography className="wideH1">Dining Room Furniture</Typography>
              <span className="font-1666 jost color-767676">
                Explore dining table sets and find the one that's just right for
                you{" "}
              </span>
            </div>
            <div className="sm-none jost font-1689 d-flexs fw-500 icon-viewall">
              <Link as={`/dining`} href={`/dining`} className="view-all">
                View All
              </Link>
              <img />
            </div>
          ...
          <div style={{ marginTop: 25 }} className="row">
            {isLoading ? (
              ...
              <>
                <Slider {...settings}>
                  {diningSetData?.length > 0 &&
                    diningSetData?.map((val: any) => (
                      <>
                        <div>
                          <Link
                          ...
                          >
                            ...
                            <div className="card2">
                              <lable
                                className="font-1654 jost color-22222 dining-room fw-500"
                                style={{
                                  overflow: "hidden",
                              ...
                              <span className="jost font-151231 color-767676">
                                Starting from{" "}
                                {
                                  val.starting_price
