    ...
    <>
      <div className="billing-box margin-top-save-countinue">
        <div className="d-flex justify-content-between mb-3">
          <label className="jost fw-500 font-18 mb-0">Price Details</label>
          <label className="jost fw-500 font-16 mb-0">{itemQty} Item</label>
        </div>
        ...
        <div className="d-flex justify-content-between">
          ...
          {couponAppliedSuccess?.dis ? (
            <p className="jost fw-500 font-15 mb-0">
              {
                totalPayableAmount
                  .toLocaleString("en-IN", {
                    style: "currency",
...
export default SaveContinueMobile;
