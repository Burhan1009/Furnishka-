...
const Living_ranges = dynamic(() => import("@/assets/Living_ranges"), {
  loading: () => (
...
function Living() {
  return (
    <>
      ...
      <Header />
      <Bedroom_furniture
        titleName={"Living Room Furniture"}
        paragraph="Discover stylish living room furniture at Jodhpuri. Elevate your space with our exquisite designs. Quality and comfort combined."
      />
      <WideRange paramKey={"living"} isSlider={true} />
      {/* <Living_ranges /> */}
      <DealsOfDay />
      <BedroomFurniture />
      <Essentials />
      <BestSelling />
      <ClientReview />
      <MetaContent paramKey={"living"}  paramField={"page"} />
      <Testimonial />
      <NewsLetter />
      <Footer />
      <Disclaimer />
