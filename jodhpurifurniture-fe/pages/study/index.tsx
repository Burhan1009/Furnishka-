...
const Study_ranges = dynamic(() => import("@/assets/Study_ranges"), {
  loading: () => (
...
function Study() {
  return (
    <>
      ...
      <Discount />
      <Header />
      <Bedroom_furniture titleName={"Study Room Furniture"}
        paragraph=" Create the study room of your dreams with the perfect study storage" />
      {/* <Study_ranges /> */}
      <WideRange paramKey={"study"}  isSlider={true}/>
      <DealsOfDay />
      <BedroomFurniture />
      <Essentials />
      <BestSelling />
      <ClientReview />
      <MetaContent paramKey={"study"}  paramField={"page"} />
      <Testimonial />
      <NewsLetter />
      <Footer />
      <Disclaimer />
