...
const SofaSet_ranges = dynamic(() => import("@/assets/SofaSet_ranges"), {
  loading: () => (
...
function SofaSet() {
  return (
    <>
      ...
      <Header />
      <Bedroom_furniture
        titleName={"Sofa Set Furniture"}
        paragraph=" Uncover Style and Comfort: Your Ideal Sofa Set is Waiting for You!"
      />
      <WideRange paramKey={"sofa"} isSlider={true} />
      {/* <SofaSet_ranges /> */}
      <DealsOfDay />
      <BedroomFurniture />
      <Essentials />
      <BestSelling />
      <ClientReview />
      <MetaContent paramKey={"sofa"}  paramField={"page"} />
      <Testimonial />
      <NewsLetter />
      <Footer />
      <Disclaimer />
