...
const Storage_ranges = dynamic(() => import("@/assets/Storage_ranges"), {
  loading: () => (
...
function Storage() {
  return (
    <>
      ...
      <Header />
      <Bedroom_furniture
        titleName={"Storage Furniture"}
        paragraph=" Create the Storage of your dreams with the perfect storage "
      />
      <WideRange paramKey={"storage"}  isSlider={true}/>
      {/* <Storage_ranges /> */}
      <DealsOfDay />
      <BedroomFurniture />
      <Essentials />
      <BestSelling />
      <ClientReview />
      <MetaContent paramKey={"storage"}   paramField={"page"}/>
      <Testimonial />
      <NewsLetter />
      <Footer />
      <Disclaimer />
